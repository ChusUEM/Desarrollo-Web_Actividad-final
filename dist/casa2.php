    ...
    <body>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <h2 class="fw-bolder">Piso de obra nueva</h2> <br></br>

                <h4 class="fw-bolder">Precio: 228.855€</h4><br></br>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                            ...
                            <img class="card-img-top" src="img/casa2/bloque.jpg" alt="..." /></div>
                            <!-- Product details-->
                            <br></br>
                            <br></br>
                ...
                $sql = "SELECT * FROM Inmuebles WHERE ID = 2";
