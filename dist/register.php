    ...
    debug_to_console("comprobacion formulario usuario");
        ...
        debug_to_console("antes de conexión a sql");
				...
				if ( $Email == $Mail ) {
					...
					echo "<div style='background-color:white;width:500px;'>";
					print " $Mail";
					mysqli_query($conex, "INSERT INTO Usuarios ('Id_Usuario', 'Nombre', 'Password', 'Email') VALUES ('$subir','$Nombre', '$pass', '$Email')") or die ("Fallo al introducir");
        ...
        <div id="contenedor" >
            ...
            <div id="contenido" class="text-center" align="right">
                <form method="POST" action="register.php"  enctype="multipart/form-data" > </br>
                    ...
                    ?></br> </br> 
                    <input type="submit" name="enviar" value="Registrarse" class="cajas" style="font-size:20px;"> </input></br> </br> </br>
